...
def test_fetch_asset_info(db_connector):
    ...
    query = """
    SELECT * FROM asset_management_test.asset_info 
    LIMIT 5
    """
...
def test_fetch_asset_ids(db_connector):
    ...
    query = """
    SELECT * FROM asset_management_test.asset_ids 
    LIMIT 5
    """
    df = db_connector.fetch_data(query)
...
def test_fetch_asset_owner(db_connector):
    ...
    query = """
    SELECT * FROM asset_management_test.asset_owner 
    LIMIT 5
    """
    df = db_connector.fetch_data(query)
...
def test_fetch_asset_transactions(db_connector):
    ...
    query = """
    SELECT * FROM asset_management_test.asset_transactions 
    LIMIT 5
    """
    df = db_connector.fetch_data(query)
...
def test_insert_asset_info(db_connector, test_asset_data):
    ...
    query = """
    INSERT INTO asset_management_test.asset_info 
...
def test_join_asset_tables(db_connector):
    ...
    FROM asset_management_test.asset_info ai
    JOIN asset_management_test.asset_owner ao 
...
def test_cleanup(db_connector):
    ...
    cleanup_query = """
    DELETE FROM asset_management_test.asset_info
    WHERE asset_id = 1001;
    """
